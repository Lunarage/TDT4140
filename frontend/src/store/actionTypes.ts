...
export enum ActionTypes {
    ...
    MYACTIVITIES_FINISHED = "MYACTIVITIES_FINISHED",
    MYACTIVITIES_LOADING = "MYACTIVITIES_LOADING",
    MYACTIVITIES_ERROR = "MYACTIVITIES_ERROR",
    STATISTICS_FINISHED = "STATISTICS_FINISHED",
